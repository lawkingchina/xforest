...
* \file logging.h 
* \brief This file provides logging facilities treating log 
* messages by their severities.This file contains facilitlies 
* to control the file.
*/
#ifndef XFOREST_BASE_LOGGING_H_
#define XFOREST_BASE_LOGGING_H_
...
/*!
* \brief If function |InitializeLogger| was invoked and was able to open
...
*     return 0;
*   }
* \param info_log_filename file for logging information
* \param warn_log_filename file for logging warning
* \param erro_log_filename file for logging error
*/
...
/*!
* \brief The basic mechanism of logging.{h,cc} is as follows:
